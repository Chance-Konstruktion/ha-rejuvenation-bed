...
class BedIntelligence:
    ...
    def update(
        ...
        # 1. Auto-Kalibrierung (wenn noch nicht abgeschlossen)
    ...
    def _update_isolation(
        ...
        Logik:
        - Wasser 29°C, Luft oben 29°C → Decke drauf, gut isoliert ✅
        - Wasser 29°C, Luft oben 22°C → Bett offen, Wärme verpufft ⚠️
        """
        ...
        threshold = self.calibration.delta_isolation_threshold

        # Isolations-Level bestimmen
        if delta < 0.5:
            iso.level = "gut"
            iso.is_covered = True
