...
**Intelligenz** – Präsenz-Erkennung durch Wassertemperatur-Varianz (kein extra Sensor nötig). Auto-Kalibrierung in 3–5 Tagen. Isolations-Erkennung (Bett zugedeckt?). Schwitz-Erkennung 2.0 per Kreuzkorrelation. Schlaf-Score 0–100. Einschlafzeit-Vorhersage mit lernbasiertem Vorheizen.
...
| `sensor.bett_schlaf_score_trend` | Trend (steigend/stabil/fallend) |
| `sensor.bett_einschlafzeit_vorhersage` | Gelernte Einschlafzeit |
